  ...
  if (array_key_exists("courseid",$_GET)) {
    ...
    elseif($_SERVER['REQUEST_METHOD'] === 'DELETE') {
      ...
      try {
        // ADD AUTH TO QUERY
        // create db query
        $query = $writeDB->prepare('delete from course_list where id = :courseid');
        $query->bindParam(':courseid', $courseid, PDO::PARAM_STR);
        $query->execute();
    ...
    elseif($_SERVER['REQUEST_METHOD'] === 'PATCH') {
      ...
      try {
        ...
        $query = $writeDB->prepare('SELECT id, name, curr, period, active, hours_theory, hours_lab, hours_practice from course_list where id = :courseid');
        $query->bindParam(':courseid', $courseid, PDO::PARAM_STR);
        $query->execute();
        ...
        $queryString = "update course_list set ".$queryFields." where id = :courseid";
        // prepare the query
